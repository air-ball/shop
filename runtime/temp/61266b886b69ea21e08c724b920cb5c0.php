<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\phpStudy\PHPTutorial\WWW\php34\shop\public/../application/admin\view\admin\edit.html";i:1561294045;s:88:"D:\phpStudy\PHPTutorial\WWW\php34\shop\public/../application/admin\view\public\base.html";i:1560992712;}*/ ?>
    ...
    <form action="" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            <tr>
                ...
                <td>
                    <input type='text' name='username' maxlength="20" value="<?php echo $admin_info['username']; ?>" size='27' /><font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td class="label">新密码:</td>
                <td>
                    <input type='password' name='password' maxlength="20" value="" size='27' placeholder="留空则不修改密码" /><font color="red">*</font>
                </td>
            </tr>
            <tr>
                    
                <td class="label">角　　色:</td>
                <td>
                    <select name="role_id">
                        ...
                        <option value="<?php echo $vo['id']; ?>" <?php if($admin_info['role_id'] == $vo['id']): ?> selected='selected' <?php endif; ?> ><?php echo $vo['role_name']; ?></option>
