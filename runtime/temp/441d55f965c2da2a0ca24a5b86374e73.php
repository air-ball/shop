<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"D:\phpStudy\PHPTutorial\WWW\php34\shop\public/../application/index\view\goods\detail.html";i:1561549162;s:90:"D:\phpStudy\PHPTutorial\WWW\php34\shop\public/../application/index\view\public\header.html";i:1561789577;s:87:"D:\phpStudy\PHPTutorial\WWW\php34\shop\public/../application/index\view\public\nav.html";i:1561789868;s:90:"D:\phpStudy\PHPTutorial\WWW\php34\shop\public/../application/index\view\public\footer.html";i:1561379746;}*/ ?>
...
<head>
	...
	<!--引入jqzoom css -->
	<link rel="stylesheet" href="__HOME__style/jqzoom.css" type="text/css">
    ...
    <!-- 顶部导航 end -->
        ...
        <div class="header w1210 bc mt15">
            ...
            <div class="logo w1210">
                <h1 class="fl"><a href="<?php echo url('index/index'); ?>"><img src="__HOME__images/logo.png" alt="京西商城"></a></h1>
                <!-- 头部搜索 start -->
                <div class="search fl">
                ...
                <div class="user fl">
                    <dl>
                        ...
                        <dd>
                            <div class="prompt">
                                <?php if(empty(\think\Session::get('user_info')) || ((\think\Session::get('user_info') instanceof \think\Collection || \think\Session::get('user_info') instanceof \think\Paginator ) && \think\Session::get('user_info')->isEmpty())): ?>
                                您好，请<a href="<?php echo url('user/login'); ?>">登录</a>
                                <?php else: ?>
                                <li>♔<?php echo \think\Session::get('user_info.username'); ?>  <a href="<?php echo url('user/logout'); ?>">退出登录</a> </li>
                                <?php endif; ?>
                            </div>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="__IMG__<?php echo $goods['imgs']['0']['goods_img']; ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img width="350px" height="350px" src="__IMG__<?php echo $goods['imgs']['0']['goods_img']; ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li <?php if($i == '1'): ?> class="cur"<?php endif; ?>>
									<a <?php if($i == '1'): ?>class="zoomThumbActive"<?php endif; ?> href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/<?php echo $vo['goods_img']; ?>',largeimage: '/<?php echo $vo['goods_img']; ?>'}">
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="<?php echo url('index/Cart/addCart'); ?>" method="post" class="choose">
						<!-- 保存商品id -->
							...
							<li class="product">
								<dl>
									...
									<dd>
										...
										<a <?php if($i == '1'): ?>class="selected"<?php endif; ?> href="javascript:;"><?php echo $v['attr_value']; ?> <input type="radio" name="attr_id['<?php echo $v['attr_id']; ?>']" value="<?php echo $v['id']; ?>" checked="checked" /></a>
										<?php endforeach; endif; else: echo "" ;endif; ?>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<?php if(is_array($goods['onlyone']) || $goods['onlyone'] instanceof \think\Collection || $goods['onlyone'] instanceof \think\Paginator): $i = 0; $__LIST__ = $goods['onlyone'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						...
						<div class="desc mt10">
							...
							<?php echo htmlspecialchars_decode($goods['goods_body']); ?>
						</div>
					</div>
					<!-- 商品介绍 end -->
