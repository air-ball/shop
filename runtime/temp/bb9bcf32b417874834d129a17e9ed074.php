<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\phpStudy\PHPTutorial\WWW\php34\shop\public/../application/admin\view\index\menu.html";i:1561371567;}*/ ?>
...
.explode {
  background:url(__ADMIN__Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(__ADMIN__Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(__ADMIN__Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="__ADMIN__Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
        ...
        <ul id="menu-ul">
            ...
            <?php echo $vo['rule_name']; ?>
                <ul>
                    ...
                    <li class="menu-item"><a href="<?php echo url($v['controller_name'].'/'.$v['action_name']); ?>" target="main-frame"><?php echo $v['rule_name']; ?></a></li>
...
<script type="text/javascript" src="__ADMIN__Js/global.js"></script>
<script type="text/javascript" src="__ADMIN__Js/utils.js"></script>
<script type="text/javascript" src="__ADMIN__Js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '__ADMIN__Images/menu_minus.gif' : '__ADMIN__Images/menu_plus.gif';
