<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\phpStudy\PHPTutorial\WWW\php34\shop\public/../application/admin\view\index\top.html";i:1561375883;}*/ ?>
...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="__ADMIN__Images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
        <ul>
            <li><a href="javascript:void()" target="_blank">欢迎！<?php echo cookie('admin_info')['username']; ?></a></li>
            <li><a href="/testTp" target="_blank">查看网店</a></li>
            <li><a href="#" target="main-frame">个人设置</a></li>
            <li style="border-right:none"><a href="">刷新</a></li>
        </ul>
        <div id="send_info">
            <a href="<?php echo url('goods/flush'); ?>" target="main-frame" class="fix-submenu">清除缓存</a>
...
<div id="menu-div">
    <ul>
        ...
        <li><a href="<?php echo url('index/index'); ?>" target="main-frame">起始页</a></li>
        <li><a href="<?php echo url('goods/index'); ?>" target="main-frame">商品列表</a></li>
