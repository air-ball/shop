			...
			<div class="guide_wrap">
				...
				<div class="hot none">
					<ul>
						...
						<li>
							<dl>
								<dt><a href="<?php echo url('goods/detail','id='.$v['id']); ?>"><img src="/<?php echo $v['goods_thumb']; ?>" alt="" /></a></dt>
								<dd><a href="<?php echo url('goods/detail','id='.$v['id']); ?>"><?php echo $v['goods_name']; ?></a></dd>
