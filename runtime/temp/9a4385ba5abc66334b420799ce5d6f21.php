<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"D:\phpStudy\PHPTutorial\WWW\php34\shop\public/../application/index\view\pay\success.html";i:1561806010;}*/ ?>
...
<head>
	...
	<link rel="stylesheet" href="__HOME__style/success.css" type="text/css">
...
<body>
	...
	<div class="success w990 bc mt15">
		...
		<div class="success_bd">
			...
			<p class="message">完成支付后，你可以 <a href="">查看订单状态</a>  <a href="<?php echo url('index/index'); ?>">继续购物</a> <a href="">问题反馈</a></p>
		</div>
	</div>
	<!-- 主体部分 end -->
