<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\phpStudy\PHPTutorial\WWW\php34\shop\public/../application/index\view\cart\index.html";i:1561549322;s:87:"D:\phpStudy\PHPTutorial\WWW\php34\shop\public/../application/index\view\public\nav.html";i:1561789868;}*/ ?>
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<tbody>
				...
				<tr>
                    <td class="col1"><a href="<?php echo url('goods/detail','id='.$vo['goods_id']); ?>">
                        <img src="/<?php echo $vo['goods']['goods_thumb']; ?>" alt="" /></a> <?php echo $vo['goods']['goods_name']; ?> <strong><a href=""></a></strong>
                    </td>
                    <td class="col2">
					...
					<td class="col4"> 
						...
						<input type="text" name="goods_count" value="<?php echo $vo['goods_count']; ?>" class="amount"
							data-goods-id="<?php echo $vo['goods_id']; ?>" data-goods-attr-ids="<?php echo $vo['goods_attr_ids']; ?>"
							/>
		...
		<div class="cart_btn w990 bc mt10">
			...
			<a href="<?php echo url('Pay/check'); ?>" class="checkout">结 算</a>
		</div>
	</div>
	<!-- 主体部分 end -->
...
$('.amount').blur(function(){
	var data ={
		...
		goods_attr_ids:$(this).attr('data-goods-attr-ids'),
